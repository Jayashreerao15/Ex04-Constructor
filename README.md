...
namespace Constructor1
{
    public class Jay
    {
        ...
        public Jay(string name, string designation, int exp, int bs, int ins)
        {
            this.name = name;
    ...
    public class program
    {
        static void Main(String[] args)
        {
            ...
            for (int i = 1; i <= n; i++)
            {
                ...
                Jay emp = new Jay(nam, desig, exp, bs, ins);
            }
 ...
 ```
 ## Output:
![image](https://user-images.githubusercontent.com/74660507/190057731-6fbdc8a2-f258-4cb8-98f4-957a958cd683.png)
